...
struct SVP : torch::nn::Module {
    ...
    std::vector<double> calibrate_avgerror(torch::Tensor input, torch::Tensor labels);
    std::vector<double> calibrate_apsavgerror(torch::Tensor input, torch::Tensor labels);
