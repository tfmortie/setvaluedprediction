...
# CIFAR10
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/CIFAR10 --config ./experiments/testrun1.yaml ./experiments/testrun2.yaml -nexp 1 -k 10 -dim 200 -hi 1000 -b 32 -ne 2 |& tee ./logs/exp_h_lac_1_cifar10.txt 
