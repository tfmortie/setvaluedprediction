...
# Debug
#python -u experiments.py -p /home/data/tfmortier/Research/Datasets/CAL256 -k 256 -dim 200 -hi 1000 -b 32 -ne 100 -c 256 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_h_aps_cal256.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/CAL256 -k 256 -dim 200 --no-hm -hi 1000 -b 32 -ne 100 -c 256 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_f_aps_cal256.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/CAL256 --rh -k 256 -dim 200 -hi 1000 -b 32 -ne 100 -c 1 256 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_rh_aps_cal256.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/PLANTCLEF -k 1000 -dim 200 -hi 1000 -l 0.0001 -b 32 -ne 100 -c 1 1000 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_h_aps_plantclef.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/PLANTCLEF -k 1000 -dim 200 --no-hm -hi 1000 -l 0.0001 -b 32 -ne 100 -c 1000 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_f_aps_plantclef.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/PLANTCLEF --rh -k 1000 -dim 200 -hi 1000 -l 0.0001 -b 32 -ne 100 -c 1 1000 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_rh_aps_plantclef.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/PROT -k 3485 -dim 26276 -hi 1000 -l 0.01 -b 32 -ne 100 -c 1 3485 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_h_aps_prot.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/PROT -k 3485 -dim 26276 --no-hm -hi 1000 -l 0.01 -b 32 -ne 100 -c 3485 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_f_aps_prot.txt
...
python -u experiments.py -p /home/data/tfmortier/Research/Datasets/PROT --rh -k 3485 -dim 26276 -hi 1000 -l 0.01 -b 32 -ne 100 -c 1 3485 -error 0.05 0.10 0.15 -svptype apsavgerrorctrl |& tee ./logs/exp_rh_aps_prot.txt
