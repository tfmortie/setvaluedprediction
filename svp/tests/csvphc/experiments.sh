...
# CIFAR10
#python -u experiments.py -p /home/data/tfmortier/Research/Datasets/CIFAR10 --config ./experiments/apsr.yaml -nexp 2 -k 10 -dim 200 -hi 1000 -b 32 -ne 10 |& tee ./logs/npsrdebug.txt
